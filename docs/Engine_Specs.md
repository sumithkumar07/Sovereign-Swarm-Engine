...
| **Recurrent Head Count** | 8 Symmetric Heads |
...
- **100% On-Device**: The internal state remains in physically local VRAM/RAM.
- **Zero-Telemetry**: No external data sync is permitted during active swarm sessions.
